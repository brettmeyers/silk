...
#    Discards stdout and stderr when the SK_TESTS_SAVEOUTPUT
#    environment varialbe is not set.  When that variable is set,
#    output is stored to the file "tests-$NAME.txt".
#
