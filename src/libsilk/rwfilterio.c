...
RCSIDENT("$SiLK: rwfilterio.c cd598eff62b9 2014-09-21 19:31:29Z mthomas $");
...
**
**    sensorID_t    sensorID;        // 36-37  Sensor ID
**
    ...
    uint8_t            *ar)
{
    ...
    if (skHeaderGetRecordVersion(rwIOS->silk_hdr) == 1) {
        ...
        rwRecSetSensor(rwrec, (sensorID_t)(sbb & MASKARRAY_08));
    }
