...
RCSIDENTVAR(rcsID_SKSTREAM_H, "$SiLK: skstream.h cd598eff62b9 2014-09-21 19:31:29Z mthomas $");
...
skStreamCheckSilkHeader(
    ...
    fileVersion_t       min_rec_version,
    fileVersion_t       max_rec_version,
    sk_msg_fn_t         err_fn);
