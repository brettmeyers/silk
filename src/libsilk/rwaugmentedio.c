...
RCSIDENT("$SiLK: rwaugmentedio.c cd598eff62b9 2014-09-21 19:31:29Z mthomas $");
...
/*
 *  status = augmentedioPrepare(&rwIOSPtr);
 *
...
#define FILE_FORMAT "FT_RWAUGMENTED"
    ...
    switch (skHeaderGetRecordVersion(hdr)) {
      case 5:
        rwIOS->rwUnpackFn = &augmentedioRecordUnpack_V5;
        rwIOS->rwPackFn   = &augmentedioRecordPack_V5;
        break;
      case 4:
        rwIOS->rwUnpackFn = &augmentedioRecordUnpack_V4;
        rwIOS->rwPackFn   = &augmentedioRecordPack_V4;
        break;
      case 3:
      case 2:
      case 1:
        ...
        rwIOS->rwUnpackFn = &augmentedioRecordUnpack_V1;
        rwIOS->rwPackFn   = &augmentedioRecordPack_V1;
        break;
      case 0:
      default:
    ...
    rwIOS->recLen = augmentedioGetRecLen(skHeaderGetRecordVersion(hdr));
