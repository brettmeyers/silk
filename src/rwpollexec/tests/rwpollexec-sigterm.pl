...
#
#
# RCSIDENT("$SiLK: rwpollexec-sigterm.pl 40a363507ed0 2014-04-01 14:09:52Z mthomas $")
...
my @expected_archive = qw(0);
my @expected_error   = qw(1);

# run it and check the MD5 hash of its output
check_md5_output('145bcc752fbaf36ba82bb06ffaa3d1c0', $cmd);
