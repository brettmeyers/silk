...
The application uses this callback function to fetch the textual value
for the field given a SiLK Flow record.  The signature of this
function is
...
$SiLK: silk-plugin.pod cd09f0a5fcc6 2014-06-14 15:43:33Z mthomas $
